...
/** Raw component and datasource definitions collected from a module's exports. */
 ...
 * collects the raw component and datasource definitions. The definitions are
 * returned verbatim — no shape mapping is applied.
 *
